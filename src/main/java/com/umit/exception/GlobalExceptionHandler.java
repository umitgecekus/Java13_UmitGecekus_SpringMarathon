...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(HastaneManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> okulOtomasyonuHandler(HastaneManagerException okulOtomasyonuException){
